...
$rezultat = mysqli_query($polaczenie,"SELECT id, od, data, temat FROM wiadomosci WHERE do = '".$_SESSION['id']."'");
$ile = mysqli_num_rows($rezultat);
echo '<h3 style="float:left;">Wiadomości:'.$ile.'</h3><a style="float:left;" href="newmail.php"><img src="newmail.png" height="50" width="50"/></a>';
echo '<table width="804" align="left" border="1" bordercolor="#d5d5d5" cellpadding="0" cellspacing="0" style="margin: 2px; background-color:#fafafa; clear:both;"><tr>';
if ($ile>=1) 
{
echo<<<END
<td width="100" align="center" bgcolor="e5e5e5">Od</td>
<td width="302" align="center" bgcolor="e5e5e5">Temat</td>
<td width="302" align="center" bgcolor="e5e5e5">Data</td>
<td width="100" align="center" bgcolor="e5e5e5">Czytaj</td>
</tr><tr>
END;
}
	...
	for ($i = 1; $i <= $ile; $i++) 
	{
		...
		$a2 = $row['temat'];
		$a3 = $row['data'];	
		$a4 = '<a href="mailread.php?id='.$row['id'].'">Czytaj</a>';		
		
echo<<<END
<td width="100" align="center">$a1</td>
<td width="302" align="center">$a2</td>
<td width="302" align="center">$a3</td>
